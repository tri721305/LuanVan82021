		  ...
		  <div className="container">
		    <div className="row">
		      <div className="col-lg-8">
		        ...
		        {/* details-gallery-end */}
		        <p>Đất Sài Gòn hiền hòa và bình yên, không hạn hán, không bão lũ nên những người gốc Gài Gòn dễ bằng lòng với cuộc sống hiện tại và phải nhờ đến những người ngoại tỉnh đến để tạo nên sự phát triển rực rỡ của thành phố như ngày hôm nay.</p>
		        {/* details-video-start */}
		        <h4 className="single-page-small-title mt-5">Content SG here. .. .. </h4>
		        <div className="video-popup-wrap style-two">
		          <div className="thumb">
		            <img src={publicUrl+"assets/img/blog-details/7.png"} alt="video" />
		          </div>
		          <div className="video-popup-btn">
		            <a href="https://www.youtube.com/watch?v=2iw_K-1AmVk" className="video-play-btn mfp-iframe"><i className="fa fa-play" /></a>
		          </div>
		        </div>
		        {/* details-video-end */}
		        {/* <p>Lorem ipsum dolor sit amet, consetetur elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p> */}
		        <p>Bên cạnh một Sài Gòn của những người lao động tự do là một Sài Gòn khác của những người thành đạt, sang trọng. Nguyễn Thanh Vân, một cử nhân Ngân hàng tốt nghiệp loại ưu từ Hà Nội, qua nhiều vòng thi tuyển hiện đang làm việc cho một ngân hàng thương mại nước ngoài. Cùng với thu nhập chính độ 2 ngàn đô mỗi tháng, cô còn tham gia sàn chứng khoán và có thêm một số khoản thu nhập ngoài lương. Là một cô gái trẻ, chưa lập gia đình nhưng cô đã kịp mua cho mình một căn hộ hạng sang trong khu đô thị của tập đoàn Đất Xanh. Mỗi năm cô giành thời gian nghỉ phép đi chơi một số nước để mở mang tầm nhìn. Gặp tôi, cô tiết lộ: cháu đã thay hai cuốn hộ chiếu rồi chú à. Mỗi lần xuất cảnh, đóng dấu thị thực vào một trang, vậy mà cuộc phiêu lưu của cô đã hết hai cuốn!</p>
		              ...
		              <div className="col-xl-5 col-lg-6 col-6  offset-xl-2">
		                <div className="nav-next w-100">
		                  <a href="#">
		                    ...
		                    <h4 className="float-right">Đà Nẵng một sức hút lạ</h4>
		                  </a> 
		                </div>
		              </div>
		            </div>
