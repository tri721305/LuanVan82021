			    ...
			    <div className="row justify-content-center">
			      <div className="col-xl-6 col-lg-9">
			        <div className="section-title text-center">
			          <h2 className="title wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.1s">Kế hoạch du lịch nổi bật</h2>
			          <p className="wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s">Goz cung cấp cho người dùng các Kế hoạch ( Plan ) nỗi bật mà các thành viên cũng như người dùng Goz trải nghiệm và dành thời gian chia sẽ. </p>
			        </div>
			      </div>
			    </div>
			    <div className="row">
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="0.4s" data-wow-delay="0.1s">
			          ...
			          <div className="details">
			            ...
			            <h4 className="title">Bình Thuận, Mũi Né</h4>
			      ...
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.3s">
			          ...
			          <div className="details">
			            ...
			            <h4 className="title">Ninh Thuận, Nha Trang</h4>
			            <p className="content">4 days 4 person</p>
			            <div className="tp-price-meta">
			              <h2>20.000.000 <small></small></h2>
			            </div>
			          </div>
			        </div>
			      </div>
			      <div className="col-lg-3 col-sm-6">
			        <div className="single-destinations-list style-two wow animated fadeInUp" data-wow-duration="1.1s" data-wow-delay="0.4s">
			          ...
			          <div className="details">
			            ...
			            <h4 className="title">Hà Nội City</h4>
